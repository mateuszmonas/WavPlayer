...
//	uint8_t ctrl_reg_3 = 0b00011000;
//	uint8_t ctrl_reg_5 = 0b00001100;
	uint8_t int_1_settings = 0b00001000;
	uint8_t int_1_treshold = 0b00001111;
//	uint8_t int_1_duration = 0b00000000;
	HAL_I2C_Mem_Write(&hi2cx, LSM303_ACC_ADDRESS, LSM303_ACC_CTRL_REG1_A, 1, &ctrl_reg_1, 1, HAL_MAX_DELAY);
//	HAL_I2C_Mem_Write(&hi2cx, LSM303_ACC_ADDRESS, LSM303_ACC_CTRL_REG3_A, 1, &ctrl_reg_3, 1, HAL_MAX_DELAY);
//	HAL_I2C_Mem_Write(&hi2cx, LSM303_ACC_ADDRESS, LSM303_ACC_CTRL_REG5_A, 1, &ctrl_reg_5, 1, HAL_MAX_DELAY);
...
//	HAL_I2C_Mem_Write(&hi2cx, LSM303_ACC_ADDRESS, LSM303_ACC_INT1_DURATION_A, 1, &int_1_duration, 1, HAL_MAX_DELAY);
}
